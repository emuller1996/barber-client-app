...
export default function FormBarber() {
  ...
  const handleInputBarber = (e) => {
    ...
    setErrors(validate({ ...barberCreated, [e.target.name]: e.target.value }));
  };
  ...
  return (
    <form onSubmit={handleSubmitCreate}>
      <div class="modal-header border-0">
        <h5 class="modal-title" id="modalBaber">
          Crear Barbero
        </h5>
        <button
          type="button"
        ...
        <div class="row ">
          <div class="form-group col-md-6">
            ...
            <input
              ...
              name="name"
              value={barberCreated.name ? barberCreated.name : ""}
          ...
          <div class="form-group col-md-6">
            ...
            <input
              ...
              name="role"
              value={barberCreated.role ? barberCreated.role : ""}
              onChange={handleInputBarber}
              id="roleBarber"
            />
            <small id="emailHelp" class="form-text text-danger">
              {errors.role ? errors.role : false}{" "}
            </small>
          </div>
          <div class="form-group col-12">
            ...
            <input
              ...
              name="image"
              value={barberCreated.image ? barberCreated.image : ""}
              onChange={handleInputBarber}
              id="imageBarber"
            />
          </div>
                      ...
                      <div className="card w-100 rounded-0">
                        <div class="card-header bg-light">
                          <input
                            checked={
                              servicesSelected &&
                              servicesSelected.includes(s._id)
                            }
      ...
      <div class="modal-footer border-0">
        ...
        <button
          disabled={
            Object.keys(errors).length > 0 || servicesSelected.length === 0
              ? true
              : false
          }
          type="submit"
